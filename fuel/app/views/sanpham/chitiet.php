                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="product-inner">
                                    ...
                                    <?php echo Html::anchor('#', 'Add to cart', array('class' => 'add-to-cart-link','value' =>$sanphams['id'], 'name'=>  $sanphams['tensanpham'],'title' => $sanphams['slug'])); ?>
                                    <br>
                                    <br>
                                    <br>
                                    <br>
                                    ...
                                    <div class="product-inner-category">
                                        <p>Category: <a href=""><?php echo $sanphams['category']; ?></a>. Tags: <a href="">awesome</a>, <a href="">best</a>, <a href="">sale</a>, <a href="">shoes</a>. </p>
                                    </div> 
                                    <div role="tabpanel">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div role="tabpanel" class="tab-pane fade" id="profile">
                                                <h2>Reviews</h2>
                                                <?php if ($current_user): 
                                                echo Form::open(array('action'=>'comment/create/'.$sanphams['id'],'method' => 'post'));
                                                ?>
