      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="http://project.dev/admin/service/gioithieu"><i class="fa fa-circle-o"></i>Giới Thiệu</a></li>
            <li><a href="http://project.dev/admin/service/lienhe"><i class="fa fa-circle-o"></i>Liên hệ</a></li>
            <li><a href="http://project.dev/admin/service/tintuc"><i class="fa fa-circle-o"></i>Tin tức</a></li>
          </ul>
        </li>
