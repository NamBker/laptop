          ...
          <ul class="dropdown-menu">
            ...
            <li>
              ...
              <li>
                <a href="#">
                  <div class="pull-left">
                    <?php echo Asset::img("admin/user4-128x128.jpg",array("class" => "img-circle")) ?>
                  </div>
                  <h4>
                    Developers
  ...
  <ul class="dropdown-menu">
    ...
    <li class="user-footer">
      <div class="pull-left">
        ...
        <a href="http://project.dev/admin/profile/<?php echo $current_user->id ?>" class="btn btn-default btn-flat">Profile</a>
      </div>
      <div class="pull-right">
        <a href="http://project.dev/admin/logout" class="btn btn-default btn-flat">Sign out</a>
      </div>
    </li>
  </ul>
</li>
