        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Listing Sanpham</h3>
              <div class="box-tools">
            ...
            <div class="box-body table-responsive no-padding">
              ...
              <?php foreach ($sanphams as $item): ?>
                <tr>
                  ...
                  <td>
                  <?php echo Html::anchor('admin/sanpham/view/'.$item->id, 'View'); ?> |
                   <?php echo Html::anchor('admin/sanpham/edit/'.$item->id, 'Edit'); ?> |
                  <?php echo Html::anchor('admin/sanpham/delete/'.$item->id, 'Delete', array('onclick' => "return confirm('Are you sure?')")); ?></td>
                </tr>
...
<?php endif; ?><p>
  <?php echo Html::anchor('admin/sanpham/create', 'Add new Sanpham', array('class' => 'btn btn-success')); ?>
