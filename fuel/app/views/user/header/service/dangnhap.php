        ...
        <div class="col-md-8">
            <div class="panel panel-login">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <form id="login-form" action="http://project.dev/dangnhap/index" method="post" role="form" style="display: block;">
                            ...
                            <form id="register-form" action="http://project.dev/register" method="post" role="form" style="display: none;">
                                <div class="form-group">
