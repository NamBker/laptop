...
<div class="col-md-8">
  <div class="panel panel-login">
    ...
    <div class="panel-body">
      <div class="row">
        <div class="col-lg-12">
          <?php echo Form::open(array('action' => 'dangnhap/index', 'method' => 'post', 'role' => 'form', 'style' => 'display: block;','id' => 'login-form')); ?>
          ...
          <?php  echo Form::close(); ?>
          <?php echo Form::open(array('action' => 'register/', 'method' => 'post', 'style' => 'display: none;','id' => 'register-form','enctype' => 'multipart/form-data')); ?>
